...
class billClass:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | Saurabh Gunjal")
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Saurabh Gunjal\nFor any Technical Issues Contact: 8767440456",font=("times new roman",10),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
